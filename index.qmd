...
## Model Summaries
- Bayesian linear model with year as the dependent variable and carbon dioxide as the independent variable
- Bayesian linear model with year as the dependent variable and temperature change as the independent variable
- Bayesian linear model with year as the dependent variable and land temperature as the independent variable
- World map model with country as the dependent variable and carbon dioxide as the independent variable
- World map model with country as the dependent variable and carbon dioxide per person as the independent variable
